...
public class Robot extends TimedRobot {
  ...
  /***
   * joystick object that is used to control romi
   */
  private final Joystick joystick = new Joystick(0); // create a Joystick object to control romi
  /***
   * drive object to access the fields within it
   */
  ...
  public void robotInit() {
    ...
    drive.right_motor.setInverted(true);
  }
